  ...
  <div class="container py-5">
    <div class="row justify-content-center">
      <div class="col-md-6 col-lg-4">
        <div class="card login-card shadow-lg p-4 mx-auto">
          <div class="card-body">
        ...
        <form method="POST">
          ...
          <button type="submit" class="btn btn-primary btn-login w-100 py-2 fw-bold mb-3 text-uppercase">
        ...
        <div class="text-center mt-3 border-top pt-3">
          <p class="small mb-1">
            Chưa có tài khoản?
            <a href="dang-ky.php" class="text-decoration-none fw-bold" style="color: #e57a8c">Đăng ký ngay</a>
          </p>
          <div class="mt-3">
